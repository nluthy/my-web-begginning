...
openid = {
	...
	sprite : 'link2.png', // usually equals to locale, is set in
	// openid-<locale>.js
     ...
     * -----------------------------------------------------------
     * 11/09/2012   DinhNN@fpt.com.vn               Disable small providers.
     *
	 * @return {Void}
	 */
	...
	getBoxHTML : function(box_id, provider, box_size, index) {
		if (this.no_sprite) {
			...
			return '<a title="' + this.image_title.replace('{provider}', provider["name"]) + '" href="javascript:openid.signin(\'' + box_id + '\');"'
					...
					+ 'class="btn ' + box_id + ' openid_' + box_size + '_btn"></a>';
		}
