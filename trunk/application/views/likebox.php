<!DOCTYPE html>
<html id="facebook" class="" lang="vi">
    <head>
        <meta http-equiv="content-type" content="text/html; charset=UTF-8"><meta charset="utf-8"><meta name="robots" content="noodp, noydir"><meta name="referrer" content="default" id="meta_referrer"><script></script><title>Facebook</title><style>body.plugin{background:transparent;overflow:hidden}body{background:#fff;color:#333;line-height:1.28;margin:0;padding:0;text-align:left;direction:ltr;unicode-bidi:embed}
            ...
            .text_align_rtl{text-align:right}._4s7c{border:1px solid #aaa;border-top-color:#315c99}.uiBoxGray{background-color:#f2f2f2;border:1px solid #ccc}
            ...
            .dashedborder{border-style:dashed}.pas{padding:5px}
            .pam{padding:10px}
            .pal{padding:20px}
            .pts{padding-top:5px}
            ...
            .mvl{margin-top:20px;margin-bottom:20px}.uiHeader h2{color:#1c2a47;font-size:16px}
            ...
            .uiHeaderSection, .uiSideHeader{background-color:#f2f2f2;border-bottom:none;border-top:solid 1px #e2e2e2;padding:4px 6px 5px}.lfloat{float:left}
            .rfloat{float:right}._8u{margin-top:1px}
            ._8o, ._8o .img{display:block}
            ._8r{margin-right:5px;margin-top:-1px}
            ._8s{margin-right:8px}
            ._8t{margin-right:10px}._42ef{overflow:hidden}.uiGrid{border:0;border-collapse:collapse;border-spacing:0}
            ...
            .uiGrid .hRght{text-align:right}.fss{font-size:9px}
            .fsm{font-size:11px}
            .fsl{font-size:13px}
            .fsxl{font-size:16px}
            ...
            .inputsearch{background:#fff url(http://static.ak.fbcdn.net/rsrc.php/v2/yV/r/IJYgcESal33.png) no-repeat left 4px;padding-left:17px}.pluginButton{background:#eceef5;border-radius:3px;border:1px solid #cad4e7;cursor:pointer;padding:2px 6px 4px;white-space:nowrap;color:#3b5998}
            ...
            .blueButton .pluginButton{background:-moz-linear-gradient(#4b64ac, #354c90);border-color:#4c69ba;border-radius:2px;box-shadow:inset 0 0 1px #526ebc;color:#fff;font-family:Helvetica;font-size:12px;font-weight:bold;line-height:20px;padding:0 5px 0 0}
            .blueButton .pluginButton.pluginButtonSmall{line-height:18px;padding:0 4px 0 0}
            .blueButton .pluginButton .pluginButtonDivider{background:-moz-linear-gradient(#405396, #263d7b);float:left;height:20px;width:1px}
            .blueButton .pluginButton .pluginButtonDividerHighlight{background:-moz-linear-gradient(#506DBC, #4059a2);float:left;height:20px;margin-right:4px;width:1px}
            ...
            .blueButton .pluginButton:hover, .blueButton .pluginButtonPressed:hover{background:-moz-linear-gradient(#5b7bd5, #4864b1);border-color:#5874c3;box-shadow:inset 0 0 1px #607fd6}
            .blueButton .pluginButtonPressed{background:-moz-linear-gradient(#3e58a3, #4c69ba);border-color:#374f92;box-shadow:inset 0 0 1px #3e58a3}
            ...
            ._4ki > li:last-child{padding-right:0}._rv{height:100px;width:100px}
            ...
            ._ry{height:24px;width:24px}a.uiLinkLightBlue{color:#6d84b4}
            a.uiLinkSubtle{color:gray}
            a.uiLinkDark{color:#141823}.sp_like{background-image:url(http://static.ak.fbcdn.net/rsrc.php/v2/y-/r/tbhIfdAHjXE.png);background-size:auto;background-repeat:no-repeat;display:inline-block;height:14px;width:14px}
            ...
            i.img u{position:absolute;top:-9999999px}.uiLayer{outline:none}._4-nd{float:right}</style><script>var ServerJSQueue=(function(){var a=[],b;return {add:function(c){if(b){b.handle(c);}else a.push(c);},run:function(){if(!window.require)return;b=new (window.require('ServerJS'))();for(var c=0;c<a.length;c++)b.handle(a[c]);}};}());document.write=function(){};var onloadRegister_DEPRECATED=function(){},onafterloadRegister_DEPRECATED=function(){},AsyncLoader=(function(){var a=false,b=false,c={loaded:1,complete:1},d=function(){},e=document,f=false;function g(){if(e.readyState in c){e.detachEvent('onreadystatechange',g);d('t_domcontent');}}function h(){if(window._cavalry&&a&&b){d('t_layout');d('t_onload');d('t_paint');_cavalry.send();window._cavalry=false;}}function i(){if(!f&&b){f=true;ServerJSQueue.run();}}function j(l,m){if('onreadystatechange' in l){l.onreadystatechange=function(){if(l.readyState in c){l.onreadystatechange=null;m();}};}else if(l.addEventListener){var n=function(){m();l.removeEventListener('load',n,false);};l.addEventListener('load',n,false);}}function k(l){var m=e.createElement("script");if(m.readyState&&m.readyState==="uninitialized"){j(m,function(){b=true;h();});m.src=l;return true;}else if(typeof XMLHttpRequest!=='undefined'){var n=new XMLHttpRequest();if("withCredentials" in n){n.onloadend=function(){b=true;h();};n.open("GET",l,true);n.send(null);return true;}}}if(window._cavalry){d=function(l){_cavalry.log(l);};if(window.addEventListener){window.addEventListener('DOMContentLoaded',function(){d('t_domcontent');},false);}else if(e.attachEvent)e.attachEvent('onreadystatechange',g);}window.onload=function(){a=true;i();h();};return {ondemandjs:null,run:function(l){this.file=l;this.execute();},load:function(l){this.file=l;if(!k(l)){this.run(l);return;}window.onload=function(){a=true;h();};e.onkeydown=e.onmouseover=e.onclick=onfocus=function(){e.onkeydown=e.onmouseover=e.onclick=onfocus=null;AsyncLoader.execute();};},execute:function(l){var m=e.createElement('script');m.src=AsyncLoader.file;m.async=true;j(m,function(){b=true;i();l&&l();h();});e.getElementsByTagName('head')[0].appendChild(m);},wakeUp:function(l,m,n){function o(){window.require("Arbiter").inform(l,m,n);}if(f){o();}else this.execute(o);}};})();AsyncLoader.run("http:\/\/static.ak.fbcdn.net\/rsrc.php\/v2\/ym\/r\/qSGdZaMaXT2.js");</script><script async="" src="likebox_data/qSGdZaMaXT2.js"></script><script>ServerJSQueue.add({"require":[["removeArrayReduce"],["markJSEnabled"],["lowerDomain"],["Primer"]],"define":[["BanzaiConfig",[],{"MAX_WAIT":150000,"MAX_SIZE":10000,"COMPRESSION_THRESHOLD":800,"gks":{"jslogger":true,"miny_compression":true,"boosted_posts":true,"time_spent":true,"time_spent_bit_array":true,"time_spent_debug":true,"useraction":true,"videos":true}},7]]});</script></head><body class="plugin gecko win Locale_vi_VN"><div class="_li"><div class="pluginSkinLight"><div class="_4s7c" style="height: 298px"><div class="pas uiBoxLightblue bottomborder"><div class="uiHeader"><div class="clearfix uiHeaderTop"><div><h3 class="uiHeaderTitle">Tìm chúng tôi trên Facebook</h3></div></div></div></div><div class="clearfix pam"><a class="_8o _8r lfloat" href="http://www.facebook.com/FPTShopOnline" tabindex="-1" aria-hidden="true" target="_blank"><img class="_s0 _rw img" src="likebox_data/373321_332042093538446_1674802315_q.jpg" alt=""></a><div class="_8u _42ef"><table class="uiGrid" cellpadding="0" cellspacing="0"><tbody><tr><td><span class="fsl fwb"><a href="http://www.facebook.com/FPTShopOnline" target="_blank">FPT Shop (Fptshop.com.vn)</a></span></td></tr><tr><td><div class="pts"><table class="uiGrid" cellpadding="0" cellspacing="0"><tbody><tr><td><div><form rel="async" ajaxify="/plugins/likebox/connect" method="post" action="/plugins/likebox/connect" onsubmit="return window.Event &amp;&amp; Event.__inlineSubmit &amp;&amp; Event.__inlineSubmit(this,event)" id="u_0_0"><input name="lsd" value="AVotig6O" autocomplete="off" type="hidden"><input autocomplete="off" name="href" value="http://facebook.com/FPTShopOnline" type="hidden"><input autocomplete="off" name="nobootload" type="hidden"><input autocomplete="off" name="iframe_referer" value="http://fptshop.com.vn/" type="hidden"><input autocomplete="off" name="ref" type="hidden"><div class="pluginConnectButton"><div class="pluginButton pluginConnectButtonDisconnected" title=""><div><button type="submit"><i class="pluginButtonIcon img sp_like sx_like_thumb"></i><span class="accessible_elem">Thích</span></button><span aria-hidden="true">Thích</span></div></div><div class="pluginButton pluginButtonPressed pluginButtonX pluginConnectButtonConnected hidden_elem" title=""><div><button type="submit"><i class="pluginButtonIcon pluginButtonXOff img sp_like sx_like_ch"></i><i class="pluginButtonIcon pluginButtonXOn img sp_like sx_like_x" title="Thích"></i><span class="accessible_elem">Thích</span></button><span aria-hidden="true">Thích</span></div></div></div></form></div></td><td class="pls"><div><span class="hidden_elem" id="u_0_1">Bạn thích bài này.</span><span id="u_0_2"></span></div></td></tr></tbody></table></div></td></tr></tbody></table></div></div><div class="mhs pluginBoxDivider"></div><div class="pts plm"><span class="hidden_elem" id="u_0_3">Bạn và 37.231 người khác thích <a href="http://www.facebook.com/FPTShopOnline" target="_blank">FPT Shop (Fptshop.com.vn)</a>.</span><span id="u_0_4">37.231 người thích <a href="http://www.facebook.com/FPTShopOnline" target="_blank">FPT Shop (Fptshop.com.vn)</a>.</span></div><div class="_43qm pluginFacepile _43qf"><ul class="uiList pam _4cg3 _509- _4ki"><li class="_43q7 pluginFacepileItem"><a title="Oh Sehun" href="http://www.facebook.com/hung.nguyenthac.14" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/624203_100003925871438_411167763_q.jpg" alt="Oh Sehun" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><a title="Tôn Ngộ Không" href="http://www.facebook.com/nguoi.khongten.1257" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/173163_100005190301908_287848078_q.jpg" alt="Tôn Ngộ Không" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><span title="Diem Le" data-jsid="anchor"><img class="_s0 _rw img" src="likebox_data/623416_100001091481974_1187851769_q.jpg" alt="Diem Le" data-jsid="img"></span></li><li class="_43q7 pluginFacepileItem"><a title="Nam KoOl" href="http://www.facebook.com/nguyenvannam90" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/186586_100003124760513_1259378658_q.jpg" alt="Nam KoOl" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><a title="Mít Sấy" href="http://www.facebook.com/mai.vuthanh.12" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/211483_100004424316648_2051032865_q.jpg" alt="Mít Sấy" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><a title="Quyên Võ" href="http://www.facebook.com/quyen.vo.3323" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/624187_100003799340590_2061957941_q.jpg" alt="Quyên Võ" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><a title="Nhut Huynh" href="http://www.facebook.com/minhnhut.mn" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/372704_100000236322880_1055686059_q.jpg" alt="Nhut Huynh" data-jsid="img"></a></li><li class="_43q7 pluginFacepileItem"><a title="Windy Thái" href="http://www.facebook.com/thai.windy" data-jsid="anchor" target="_blank"><img class="_s0 _rw img" src="likebox_data/275560_100003163610738_1581748805_q.jpg" alt="Windy Thái" data-jsid="img"></a></li></ul></div><div class="mhs pluginBoxDivider pluginBoxDividerGray"></div><div class="clearfix pvs phm"><a class="_8o _8r lfloat" target="_blank" href="https://www.facebook.com/help/?page=209089222464503" tabindex="-1" aria-hidden="true"><i class="img sp_like sx_like_fav"></i></a><div class="_8u _42ef"><div class="fss fwn fcg"><a class="uiLinkSubtle" target="_blank" href="https://www.facebook.com/help/?page=209089222464503">Plugin xã hội của Facebook</a></div></div></div></div></div></div><script>function envFlush(a){function b(c){for(var d in a)c[d]=a[d];}if(window.requireLazy){requireLazy(['Env'],b);}else{Env=window.Env||{};b(Env);}}envFlush({"fb_dtsg":"AQAPe28v","ajaxpipe_token":"AXjDBlUt4W54mI8B","no_cookies":1,"lhsh":"fAQGUgFBL","user":"0"});</script><script>


    ServerJSQueue.add({"require":[["m_0_1"],["PluginConnection","init",["m_0_3","m_0_4"],[[["http:\/\/facebook.com\/FPTShopOnline",{"__m":"m_0_3"},"hidden_elem","platform\/plugins\/disconnect"],["http:\/\/facebook.com\/FPTShopOnline",{"__m":"m_0_4"},"hidden_elem","platform\/plugins\/connect"]]]],["PluginConnection","init",["m_0_5","m_0_6"],[[["http:\/\/facebook.com\/FPTShopOnline",{"__m":"m_0_5"},"hidden_elem","platform\/plugins\/disconnect"],["http:\/\/facebook.com\/FPTShopOnline",{"__m":"m_0_6"},"hidden_elem","platform\/plugins\/connect"]]]]],"instances":[["m_0_1",["PluginConnectButton","m_0_0"],[{"plugin":"likebox","identifier":"http:\/\/facebook.com\/FPTShopOnline","connected":false,"canpersonalize":false,"autosubmit":false,"form":{"__m":"m_0_0"}}],1]],"define":[["FbtraceForcedByServer",[],{"forced":false},140],["ServerNonce",[],{"ServerNonce":"HXu5jw4rC3_0CkdzTA7_3n"},141]],"elements":[["m_0_0","u_0_0",2],["m_0_3","u_0_1",2],["m_0_4","u_0_2",2],["m_0_5","u_0_3",2],["m_0_6","u_0_4",2],["m_0_2","u_0_0",2]]});
